...
export function events (){
    ...
    variaveis.button2.addEventListener('click', ()=>{
        variaveis.buttonPressAudio.play()
            ...
            variaveis.pagina.classList.remove('light')
            fotoDeFundo = []
            variaveis.music.pause()
  ...
  export function hack (){
    document.addEventListener('keydown', (event)=>{
        if(event.key === "Escape" || event.keyCode === 27){
            ...
            variaveis.fundo.style.backgroundRepeat = 'no-repeat'
            variaveis.fundo.style.backgroundSize = 'cover'
            variaveis.fundo.style.backgroundPosition = 'bottom center scroll'
    ...
    document.addEventListener('keydown', (event)=>{
      if(event.key === "F2"){
          variaveis.int1.classList.remove('opacit')
          variaveis.int11.classList.remove('opacit')
          variaveis.int2.classList.remove('opacit')
          variaveis.int22.classList.remove('opacit')
          variaveis.int3.classList.remove('opacit')
          variaveis.int33.classList.remove('opacit')
          variaveis.int4.classList.remove('opacit')
          variaveis.int44.classList.remove('opacit')
          variaveis.int5.classList.remove('opacit')
          variaveis.int55.classList.remove('opacit')
          variaveis.int6.classList.remove('opacit')
          variaveis.int66.classList.remove('opacit')
          variaveis.int7.classList.remove('opacit')
          variaveis.int77.classList.remove('opacit')
      }
    })
    document.addEventListener('keydown', (event)=>{
        if(event.key === "F4"){
    ...
    variaveis.optionHack.addEventListener('click', (event)=>{
        
         variaveis.int1.classList.add('opacit')
          variaveis.int11.classList.add('opacit')
          variaveis.int2.classList.add('opacit')
          variaveis.int22.classList.add('opacit')
          variaveis.int3.classList.add('opacit')
          variaveis.int33.classList.add('opacit')
          variaveis.int4.classList.add('opacit')
          variaveis.int44.classList.add('opacit')
          variaveis.int5.classList.add('opacit')
          variaveis.int55.classList.add('opacit')
          variaveis.int6.classList.add('opacit')
          variaveis.int66.classList.add('opacit')
          variaveis.int7.classList.add('opacit')
          variaveis.int77.classList.add('opacit')
